                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td data-title='Acciones' class="text-center">
                                                                <a href="modulo_edit.php"?vmar_cod=<?php echo $mar['mar_cod'];?>" class="btn btn-warning btn-sm" role='button'
                                                                   data-title='Editar' rel='tooltip' data-placement='top'>
                                                                    <span class="glyphicon glyphicon-edit"></span>
                                                                </a>
                                                                <a href="modulo_del.php"?vmar_cod=<?php echo $mar['mar_cod'];?>" class="btn btn-danger btn-sm" role='button'
