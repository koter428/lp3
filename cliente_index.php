                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="box box-primary">
                                <div class="box-header">
                                    ...
                                    <div class="box-tools">
                                        <a href="cliente_add.p" class="btn btn-primary pull-right btn-sm" data-title="Agregar" rel="tooltip">
                                                    ...
                                                    <?php foreach ($clientes as $cliente) { ?>
                                                        <tr>
                                                            ...
                                                            <td data-title="Acciones" class="text-center">
                                                                <a href="cliente_edit.php?vcli_cod=<?php echo $cliente['cli_cod'];?>" class="btn btn-warning btn-sm" role="buttom" 
                                                                   data-title="Editar" rel="tooltip"><i class="fa fa-edit"></i>
                                                                </a>
                                                                <a href="cliente_del.php?vcli_cod=<?php echo $cliente['cli_cod'];?>" class="btn btn-danger btn-sm" role="buttom" 
                                                                   data-title="Borrar" rel="tooltip"><i class="fa fa-trash"></i>
                                                                </a>                                                                
                                                            </td>
                                                        </tr>                                                         
                                                    <?php } ?>
