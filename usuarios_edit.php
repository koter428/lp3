                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" name="vusu_nick" class="form-control" required="" value="<?php echo $resultado[0]['usu_nick'] ?>" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" name="vusu_clave" class="form-control" required="" value="<?php echo $resultado[0]['usu_clave'] ?>" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">Empleado:</label>
                                        <div class="col-lg-6">
                                            <input type="text" name="vemp_cod" class="form-control" required="" value="<?php echo $resultado[0]['emp_cod'] ?>" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">grupo:</label>
                                        <div class="col-lg-6">
                                            <input type="text" name="vgru_cod" class="form-control" required="" value="<?php echo $resultado[0]['gru_cod'] ?>" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">Sucursal:</label>
                                        <div class="col-lg-6">
                                            <input type="text" name="vid_sucursal" class="form-control" required="" value="<?php echo $resultado[0]['id_sucursal'] ?>" />
                                        </div>
                                    </div>
                                </div>
