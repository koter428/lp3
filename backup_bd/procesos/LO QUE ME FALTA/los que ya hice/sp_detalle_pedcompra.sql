-- Function: sp_detalle_pedcompra(integer, integer, integer, integer, integer, integer)

-- DROP FUNCTION sp_detalle_pedcompra(integer, integer, integer, integer, integer, integer);

CREATE OR REPLACE FUNCTION sp_detalle_pedcompra(
    ban integer,
    vcom_cod integer,
    vdep_cod integer,
    vart_cod integer,
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION sp_detalle_pedcompra(integer, integer, integer, integer, integer, integer)
  OWNER TO postgres;

  /*
	select sp_detalle_pedcompra( 1, 1, 1,3, 125, 97250) as resul
