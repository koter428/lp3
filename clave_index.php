                                        ...
                                        <div class="form-group">
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-4 col-md-4 col-sm-4">
                                                    <input type="password" name="vusu_clave" class="form-control" required="" placeholder="Ingrese La Clave Actual"/>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label col-lg-2">Clave Nueva:</label>
                                               <div class="col-lg-4 col-md-4 col-sm-4">
                                                    <input type="password" name="vusu_clave" class="form-control" required="" placeholder="Ingrese La Nueva Clave"/>                                                
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label col-lg-2">Repetir clave nueva:</label>
                                                <div class="col-lg-4 col-md-4 col-sm-4">
                                                    <input type="password" name="vusu_clave" class="form-control" required="" placeholder="Ingrese Nuevamente La Clave Nueva"/>                                                
                                                </div>
                                            </div>
                                        </div>
                                    </div> 
